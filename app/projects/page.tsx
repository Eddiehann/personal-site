...
const projects = [
	{
		...
		skill: "Javascript, Node.js, SQL",
		desc: "Full-stack Management Platform",
		detail: [
		...
		link: "https://github.com/Eddiehann/study-group-manager",
	},
	{
		...
		<div className="grid gap-8 py-2 font-normal">
			...
			{projects.map((project, i) => (
				<section
					...
					onClick={() => setDropDown(dropDown === i ? -1 : i)}
				>
					{" "}
					{/* set to -1 if already open */}
